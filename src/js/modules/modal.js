...
export default class ModalLimits {
    ...
    addModalEvents = ( ) => {
        ...
        const trap = new FocusTrap(
            this.html.modal,
            "button:not([disabled]), input[type='number']:not([disabled])"
        );
    };
    ...
    getSelectors( ) {
        ...
        this.html.closebutton = document.querySelector(
            `.${this.nameSpace}__button--close`
        );
        this.html.submit = document.getElementById( `${this.nameSpace}Submit` );
        this.html.openBtn = document.querySelector( `.${this.openBtn}` );
        this.html.allInputs = Array.from(
            document.querySelectorAll( `.${this.nameSpace}__input` )
        );
    }
    ...
    submitButtonDisabled( ) {
        ...
        valid
            ? this.html.submit.removeAttribute( "disabled" )
    ...
    handleState( openState ) {
        ...
        this.openModalState
            ? this.html.modal.classList.add( `${this.nameSpace}__bg--show` )
